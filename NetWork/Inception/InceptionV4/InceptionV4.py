...
class ReducationB(nn.Module):
    def __init__(self, in_channels,out_channels):
        ...
        self.branch_1 = nn.Sequential(
            ...
            nn.Conv2d(256,256,kernel_size=(1,7),padding=(0,3),bias=False),
            nn.Conv2d(256,256,kernel_size=(7,1),padding=(3,0),bias=False),        
            nn.Conv2d(in_channels=256,out_channels=320,kernel_size=3,stride=2)
        )

        self.branch_2 = nn.Sequential(
            nn.Conv2d(in_channels ,out_channels=192, kernel_size=1),
